...
NAME_POSITION = (int(279.04052936447994 + 150), int(247.16556134400003 + 15))  # Имя на awarded: (немного опустил Y)

NAME_FONT_SIZE = 30  # Уменьшил размер шрифта
...
def generate_certificate(data, template_path, output_folder, lato_bold_path, lato_regular_path):
    ...
    try:
        ...
        page.insert_textbox(name_rect, name, fontsize=NAME_FONT_SIZE, fontname="Lato-Bold", color=(1, 0, 0), align=fitz.TEXT_ALIGN_CENTER) # Красный цвет
